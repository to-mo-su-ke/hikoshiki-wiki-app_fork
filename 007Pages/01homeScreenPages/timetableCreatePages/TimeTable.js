  ...
  const renderCellContent = (cellData, day, period) => {
    ...
    if (cellData[0]) {
      return (
        <View style={timeTableStyles.fullCellContainer}>
          <Text style={timeTableStyles.fullCell}>{info0.title}</Text>
          <TouchableOpacity
            style={timeTableStyles.closeButton}
            onPress={() =>
              dispatch({
                type: "REMOVE_COURSE",
                payload: {
          ...
          >
            <Text style={timeTableStyles.closeText}>×</Text>
          </TouchableOpacity>
        </View>
      );
    }
    ...
    return (
      <View style={timeTableStyles.splitCell}>
        <View style={timeTableStyles.quarterContainer}>
          <Text style={timeTableStyles.quarterCell}>{info1.title || ""}</Text>
          {cellData[1] && (
            <TouchableOpacity
              style={timeTableStyles.closeButton}
              onPress={() =>
        ...
        <View style={timeTableStyles.quarterContainer}>
          <Text style={timeTableStyles.quarterCell}>{info2.title || ""}</Text>
          {cellData[2] && (
            <TouchableOpacity
              style={timeTableStyles.closeButton}
              onPress={() =>
